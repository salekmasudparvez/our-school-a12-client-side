...
const Contact = () => {
    return (
        <div className="grid bg-white max-w-screen-xl pt-[107px] grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 text-gray-800">
