...
const SinginForm = () => {
    ...
    return (
        ...
        <div className="bg-white w-full">
            <div className="hero-content bg-white min-h-screen w-full  gap-0 py-10  p-0 flex-col lg:flex-row-reverse">
                <div className="text-center hidden lg:flex w-1/2 rounded-md   lg:text-left">
                    ...
                    <button className="text-xl border hover:bg-first p-2 hover:text-white focus:border-b-black rounded absolute btn  top-1 right-1 bg-white">
                        <Link className="flex justify-center gap-1 bg-transparent items-center text-gray-700 " to='/'>
                            <Icon icon="grommet-icons:logout" />
                            <span>Back to home</span>
                        </Link>
                    </button>
                </div>
                <div className=" lg:w-1/2 w-full px-4 gap-6 max-w-lg mx-auto  h-full flex flex-col justify-center min-w-64">
                    ...
                    <button onClick={handleGithubSingUp} type="button" className="flex bg-white btn text-gray-700 items-center justify-center mb-10 w-full hover:bg-first hover:text-white space-x-2 border rounded-md ">
